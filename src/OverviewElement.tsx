  ...
  return (
    <div className="flex flex-col bg-[#171717] rounded-lg font-['Roboto_Mono'] w-full max-w-[350px] md:max-w-[590px]">
      ...
      <div className="flex flex-row border-y border-[#262626]">
        <span className="flex items-center justify-center text-center font-bold text-[26px] md:text-[60px] text-[#00FF04] p-3 w-1/2 md:w-2/3 leading-tight">
          Tech Bro Cryptard
        </span>
      ...
      <div className="flex flex-col md:flex-row border-y border-[#262626]">
        <div className="p-3 flex items-center justify-center w-full md:w-1/2">
          <img
            src="https://static.wikia.nocookie.net/prodigyroleplay/images/5/5b/Ezgif-5-30f701527f.jpg"
            alt="Tech Bro Cryptard"
      ...
      <div className="p-2 md:p-4 flex flex-col gap-2">
        ...
        <span className="font-300 text-sm md:text-base">
          Corem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
          vulputate libero et velit interdum, ac aliquet odio mattis.
        </span>
        <div className="w-full text-[#606060] select-none overflow-hidden text-sm md:text-base">
          /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        </div>
      </div>
    </div>
